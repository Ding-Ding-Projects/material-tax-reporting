...
<details>
<summary><strong>Shared agent instructions (sanitized mirror)</strong> — the full rule set governing work in this repository: Git and release discipline, product surface contracts, accessibility, documentation, and verification requirements</summary>
