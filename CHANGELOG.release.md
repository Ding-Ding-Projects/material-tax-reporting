...
- Added release evidence for source commit, unsigned status, SHA-256 hashes, workflow timing, line counts, and a public dim-sum catalog code name when one is available.
